...
public:
    ...
    {
        _accel_desired.x = accel_lat_cms;
        _accel_desired.y = accel_lon_cms;
    }
    ...
    {
        _vel_desired.x = vel_lat_cms;
        _vel_desired.y = vel_lon_cms;
    }
    ...
    {
        _vehicle_horiz_vel = vel_xy;
        _flags.vehicle_horiz_vel_override = true;
    }
